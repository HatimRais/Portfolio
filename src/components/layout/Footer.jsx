...
export function Footer() {
  ...
  return (
    <footer className="border-t border-slate-200/80 bg-white/40 py-10 backdrop-blur-sm dark:border-white/10 dark:bg-slate-950/40">
      <div className="mx-auto flex min-w-0 max-w-6xl flex-col items-center justify-between gap-4 px-3 text-center text-sm text-slate-500 sm:px-4 dark:text-slate-400 md:flex-row md:text-left">
        <p>
